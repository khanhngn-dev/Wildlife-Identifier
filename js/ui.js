...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    // Change the icon to the hourglass
    searchForm.querySelector('i').className="fas fa-hourglass-half";
    // Change the text into "Loading..."
    searchForm.querySelector('#search-tag').innerHTML = "Loading...";
    // Disable the button
    searchForm.querySelector('#search-btn').setAttribute('disabled', true);
  }
  else {
    // Reset the icon to the magnify glass
    searchForm.querySelector('i').className="fas fa-search";
    // Reset the text to "Search"
    searchForm.querySelector('#search-tag').innerHTML = "Search";
    // Enable the button for the next search
    searchForm.querySelector('#search-btn').removeAttribute('disabled');
  }
}
